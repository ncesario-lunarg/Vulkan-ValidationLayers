...
mkdir build-android-cmake
cmake -DUPDATE_DEPS=ON -DCMAKE_BUILD_TYPE=Debug -GNinja -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK_HOME/build/cmake/android.toolchain.cmake -DANDROID_PLATFORM=26 -DANDROID_TOOLCHAIN=clang -DANDROID_ABI=arm64-v8a -DANDROID_STL=c++_static -B build-android-cmake/ -DANDROID_BUILD_TOOLS=31.0.0-rc1
```

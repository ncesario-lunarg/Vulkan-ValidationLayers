...
# Use aapt from latest build-tools by default
...
function create_APK() {
    $aapt package -f -M AndroidManifest.xml -I "$ANDROID_SDK_HOME/platforms/${ANDROID_PLATFORM}/android.jar" -S res -F bin/$1-unaligned.apk bin/libs
